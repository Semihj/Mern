...
export default function ListingItem({listing}) {
  ...
  return (
    ...
    transition-shadow gap-4  overflow-hidden rounded-lg w-full sm:w-[330px] ' >
      <Link to={`/listing/${listing._id}`}>

        <img src={listing.imageUrls[0]} alt="listing cover" 
        className='h-[320px] sm:h-[220px] w-full object-cover hover:scale-105 tranisiton-scale duration-300 '
        />
