...
export default function Profile() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto ' >
      ...
      <img src={ formData.avatar || currentUser.avatar} onClick={() => fileRef.current.click() } className='rounded-full h-24 w-24 object-cover mt-2 self-center cursor-pointer' alt="" />
